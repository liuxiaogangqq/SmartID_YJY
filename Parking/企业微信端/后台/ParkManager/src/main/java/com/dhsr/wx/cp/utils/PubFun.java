...
public class PubFun {
    public static String weburl = "https://campus.taiji.com.cn/VMS_NET_WX";
    public static String weburls = "https://campus.taiji.com.cn/vmsnet";
    //public static String wxurl = "";//加密
    public static String wxurlend = "&response_type=code&scope=snsapi_base&state=vmsnet#wechat_redirect";
        ...
        try {
            ...
            for (int idx = 0; idx < nodeList.getLength(); ++idx) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    obj.put(element.getNodeName(), element.getTextContent());
                }
            }
