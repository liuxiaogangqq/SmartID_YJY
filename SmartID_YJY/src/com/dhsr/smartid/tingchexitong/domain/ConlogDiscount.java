...
public class ConlogDiscount {
    private Integer ConLogInnerId;
	...
	private Integer ErrorConLogInnerId;
	private Integer Operator;
	private String Remark;
	private String StandbyA; // 流水号
	private Integer StandbyB;
	private String StandbyC;
	private String StandbyD;
	private String Rules;
	public ConlogDiscount() {
		super();
	}
	public ConlogDiscount(Integer conLogInnerId, Integer markInnerId, String markId, Integer markTypeInnerId,
			Integer userInnerId, Integer departmentInnerId, Integer companyInnerId, Integer conTerminalInnerId,
			Integer terminalTypeInnerId, Integer merchantInnerId, Integer appInnerId, Integer areaInnerId,
			Integer personMoney, Integer allowanceMoney, Integer numberMoney, Integer personBFMoney,
			Integer personAFMoney, Integer allowanceBFMoney, Integer allowanceAFMoney, Integer numberBFMoney,
			Integer numberAFMoney, Integer money1, Integer money2, Integer money, Integer discountMoney,
			Integer proportion, String conDatetime, String uploadDatetime, Integer conTypeInnerId, Integer conPattern,
			Integer conWay, Integer limitTimes, Integer offLine, Integer errorConLogInnerId, Integer operator,
			String remark, String standbyA, Integer standbyB, String standbyC, String standbyD, String rules) {
		super();
	...
	public Integer getConLogInnerId() {
		return ConLogInnerId;
	}
	public void setConLogInnerId(Integer conLogInnerId) {
		ConLogInnerId = conLogInnerId;
	}
	...
	public Integer getErrorConLogInnerId() {
		return ErrorConLogInnerId;
	}
	public void setErrorConLogInnerId(Integer errorConLogInnerId) {
		ErrorConLogInnerId = errorConLogInnerId;
	}
	...
	public Integer getStandbyB() {
		return StandbyB;
	}
	public void setStandbyB(Integer standbyB) {
		StandbyB = standbyB;
	}
	...
	public String toString() {
		return "ConlogDiscount [ConLogInnerId=" + ConLogInnerId + ", MarkInnerId=" + MarkInnerId + ", MarkId=" + MarkId
