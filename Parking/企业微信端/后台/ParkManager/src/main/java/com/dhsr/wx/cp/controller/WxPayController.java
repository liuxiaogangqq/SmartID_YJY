...
public class WxPayController {
    ...
    @Pass
    public String parseOrderNotifyResult(@RequestBody String xmlData) throws WxPayException, BusinessException {
        final WxPayOrderNotifyResult notifyResult = this.wxService.parseOrderNotifyResult(xmlData);
        // TODO 根据自己业务场景需要构造返回对象

        parkInfoService.updateWXRecordInfo(notifyResult);
