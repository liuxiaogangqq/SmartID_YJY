...
$('#sAccountTypeInnerId').multiselect({
	buttonWidth : '170px',
	buttonHeight : '28px',
...
function table() {
	...
	$("#table").datagrid({
		...
		url : "lsAccountLog/select.html", // 发送的url地址
		queryParams :
		// 参数列表
		{
			UserId : $('#sUserId').val(),
		...
		pageList : [ 7, 10, 15, 20, 50, 100, 200, 500 ],
		onSortColumn : alertColumn,
		columns : [ [ {
			field : 'AccountLogInnerId',
			hidden : true
		}, {
			field : 'UserId',
			title : '人员编号',
